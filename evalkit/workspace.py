...
```bash
evalkit run --rubric {name}/rubric.yaml --input {name}/data.csv --db {name}/evalkit.sqlite --report {name}/report.html
```
...
```bash
evalkit backtest --rubric {name}/rubric.yaml --input {name}/data.csv --golden-set {name}/golden_set.csv --outcomes {name}/outcomes.csv --db {name}/backtest.sqlite --report {name}/backtest-report.html
```
"""
